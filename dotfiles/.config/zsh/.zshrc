...
PS1="%B%{$fg[yellow]%}[%{$fg[blue]%}%n%{$fg[grey]%}@%{$fg[grey]%}%M %{$fg[green]%}%~%{$fg[yellow]%}]%{$reset_color%}"\$vcs_info_msg_0_$'\n'"$%b "
...
#GIT STUFF
#source https://github.com/jleclanche/dotfiles/blob/master/.zshrc
setopt promptsubst
...
local _repo="%{$fg[green]%} %{$fg[yellow]%}%{$reset_color%}"
